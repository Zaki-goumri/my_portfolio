...
import Image from "next/image";
 ...
 const Footer = () => {
    ...
    <main className="flex flex-col items-center text-neutral-200">
     <p className="flex font-medium text-xs ">Loosely designed in &nbsp; <Image src="/assets/figma.svg" height={11} width={7.33}/>&nbsp; Figma and coded in Visual Studio Code by yours truly. </p>
